...
def api_modelos_nhtsa():
    # Usamos request.args.get porque "marca" é um parâmetro de query string (?marca=...),
    # não parte da URL fixa nem do corpo (JSON) da requisição. O segundo argumento
    # ("Honda") é um valor padrão, usado quando o cliente não informa "marca" na URL.
